...
Users of the `saariuslystoned` downstream should follow [SAARI_DOWNSTREAM.md](SAARI_DOWNSTREAM.md) for the maintained OpenShell/NemoClaw release pair, subscription-provider scope, and upgrade contract.
