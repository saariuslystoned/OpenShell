...
- Source implementation is committed at
  ...
  repair is `ec5fa30048b7fbde6a12d7f41f20909666963f28`. The implementation and
  repairs are committed locally; the refreshed proof successor and public-fork
  push remain before independent exact-head semantic review.
