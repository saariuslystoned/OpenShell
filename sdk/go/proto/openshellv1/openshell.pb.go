...
const file_openshell_proto_rawDesc = "" +
	...
	"\amembers\x18\x01 \x03(\v2\x1d.openshell.v1.WorkspaceMemberR\amembers*u\n" +
...
var file_openshell_proto_goTypes = []any{
	...
	(*MainProcessExit)(nil),                              // 142: openshell.v1.MainProcessExit
	(*MainProcessExitAck)(nil),                           // 143: openshell.v1.MainProcessExitAck
	(*RelayOpen)(nil),                                    // 144: openshell.v1.RelayOpen
	(*SshRelayTarget)(nil),                               // 145: openshell.v1.SshRelayTarget
	(*TcpRelayTarget)(nil),                               // 146: openshell.v1.TcpRelayTarget
	(*RelayInit)(nil),                                    // 147: openshell.v1.RelayInit
	(*RelayFrame)(nil),                                   // 148: openshell.v1.RelayFrame
	(*RelayOpenResult)(nil),                              // 149: openshell.v1.RelayOpenResult
	(*RelayClose)(nil),                                   // 150: openshell.v1.RelayClose
	(*L7RequestSample)(nil),                              // 151: openshell.v1.L7RequestSample
	(*DenialSummary)(nil),                                // 152: openshell.v1.DenialSummary
	(*DenialGroupCount)(nil),                             // 153: openshell.v1.DenialGroupCount
	(*NetworkActivitySummary)(nil),                       // 154: openshell.v1.NetworkActivitySummary
	(*PolicyChunk)(nil),                                  // 155: openshell.v1.PolicyChunk
	(*DraftPolicyUpdate)(nil),                            // 156: openshell.v1.DraftPolicyUpdate
	(*SubmitPolicyAnalysisRequest)(nil),                  // 157: openshell.v1.SubmitPolicyAnalysisRequest
	(*SubmitPolicyAnalysisResponse)(nil),                 // 158: openshell.v1.SubmitPolicyAnalysisResponse
	(*GetDraftPolicyRequest)(nil),                        // 159: openshell.v1.GetDraftPolicyRequest
	(*GetDraftPolicyResponse)(nil),                       // 160: openshell.v1.GetDraftPolicyResponse
	(*ApproveDraftChunkRequest)(nil),                     // 161: openshell.v1.ApproveDraftChunkRequest
	(*ApproveDraftChunkResponse)(nil),                    // 162: openshell.v1.ApproveDraftChunkResponse
	(*RejectDraftChunkRequest)(nil),                      // 163: openshell.v1.RejectDraftChunkRequest
	(*RejectDraftChunkResponse)(nil),                     // 164: openshell.v1.RejectDraftChunkResponse
	...
	nil,                                                  // 196: openshell.v1.MainProcessSpec.EnvironmentEntry
...
var file_openshell_proto_depIdxs = []int32{
	5,   // 0: openshell.v1.HealthResponse.status:type_name -> openshell.v1.ServiceStatus
	5,   // 1: openshell.v1.GetGatewayInfoResponse.status:type_name -> openshell.v1.ServiceStatus
	17,  // 2: openshell.v1.GetGatewayInfoResponse.compute_drivers:type_name -> openshell.v1.ComputeDriverInfo
	18,  // 3: openshell.v1.ComputeDriverInfo.capabilities:type_name -> openshell.v1.ComputeDriverCapabilities
	220, // 4: openshell.v1.Sandbox.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	20,  // 5: openshell.v1.Sandbox.spec:type_name -> openshell.v1.SandboxSpec
	25,  // 6: openshell.v1.Sandbox.status:type_name -> openshell.v1.SandboxStatus
	195, // 7: openshell.v1.SandboxSpec.environment:type_name -> openshell.v1.SandboxSpec.EnvironmentEntry
	24,  // 8: openshell.v1.SandboxSpec.template:type_name -> openshell.v1.SandboxTemplate
	221, // 9: openshell.v1.SandboxSpec.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	22,  // 10: openshell.v1.SandboxSpec.resource_requirements:type_name -> openshell.v1.ResourceRequirements
	21,  // 11: openshell.v1.SandboxSpec.main_process:type_name -> openshell.v1.MainProcessSpec
	196, // 12: openshell.v1.MainProcessSpec.environment:type_name -> openshell.v1.MainProcessSpec.EnvironmentEntry
	23,  // 13: openshell.v1.ResourceRequirements.gpu:type_name -> openshell.v1.GpuResourceRequirements
	197, // 14: openshell.v1.SandboxTemplate.labels:type_name -> openshell.v1.SandboxTemplate.LabelsEntry
	198, // 15: openshell.v1.SandboxTemplate.annotations:type_name -> openshell.v1.SandboxTemplate.AnnotationsEntry
	199, // 16: openshell.v1.SandboxTemplate.environment:type_name -> openshell.v1.SandboxTemplate.EnvironmentEntry
	...
	1,   // 20: openshell.v1.SandboxStatus.phase:type_name -> openshell.v1.SandboxPhase
	26,  // 21: openshell.v1.SandboxStatus.main_process:type_name -> openshell.v1.MainProcessStatus
	0,   // 22: openshell.v1.MainProcessStatus.state:type_name -> openshell.v1.MainProcessState
	200, // 23: openshell.v1.PlatformEvent.metadata:type_name -> openshell.v1.PlatformEvent.MetadataEntry
	20,  // 24: openshell.v1.CreateSandboxRequest.spec:type_name -> openshell.v1.SandboxSpec
	201, // 25: openshell.v1.CreateSandboxRequest.labels:type_name -> openshell.v1.CreateSandboxRequest.LabelsEntry
	202, // 26: openshell.v1.CreateSandboxRequest.annotations:type_name -> openshell.v1.CreateSandboxRequest.AnnotationsEntry
	19,  // 27: openshell.v1.SandboxResponse.sandbox:type_name -> openshell.v1.Sandbox
	19,  // 28: openshell.v1.ListSandboxesResponse.sandboxes:type_name -> openshell.v1.Sandbox
	223, // 29: openshell.v1.ListSandboxProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	19,  // 30: openshell.v1.AttachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	19,  // 31: openshell.v1.DetachSandboxProviderResponse.sandbox:type_name -> openshell.v1.Sandbox
	53,  // 32: openshell.v1.ListServicesResponse.services:type_name -> openshell.v1.ServiceEndpointResponse
	220, // 33: openshell.v1.ServiceEndpoint.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	52,  // 34: openshell.v1.ServiceEndpointResponse.endpoint:type_name -> openshell.v1.ServiceEndpoint
	203, // 35: openshell.v1.ExecSandboxRequest.environment:type_name -> openshell.v1.ExecSandboxRequest.EnvironmentEntry
	57,  // 36: openshell.v1.ExecSandboxEvent.stdout:type_name -> openshell.v1.ExecSandboxStdout
	58,  // 37: openshell.v1.ExecSandboxEvent.stderr:type_name -> openshell.v1.ExecSandboxStderr
	59,  // 38: openshell.v1.ExecSandboxEvent.exit:type_name -> openshell.v1.ExecSandboxExit
	145, // 39: openshell.v1.TcpForwardInit.ssh:type_name -> openshell.v1.SshRelayTarget
	146, // 40: openshell.v1.TcpForwardInit.tcp:type_name -> openshell.v1.TcpRelayTarget
	61,  // 41: openshell.v1.TcpForwardFrame.init:type_name -> openshell.v1.TcpForwardInit
	56,  // 42: openshell.v1.ExecSandboxInput.start:type_name -> openshell.v1.ExecSandboxRequest
	64,  // 43: openshell.v1.ExecSandboxInput.resize:type_name -> openshell.v1.ExecSandboxWindowResize
	220, // 44: openshell.v1.SshSession.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	19,  // 45: openshell.v1.SandboxStreamEvent.sandbox:type_name -> openshell.v1.Sandbox
	68,  // 46: openshell.v1.SandboxStreamEvent.log:type_name -> openshell.v1.SandboxLogLine
	28,  // 47: openshell.v1.SandboxStreamEvent.event:type_name -> openshell.v1.PlatformEvent
	69,  // 48: openshell.v1.SandboxStreamEvent.warning:type_name -> openshell.v1.SandboxStreamWarning
	156, // 49: openshell.v1.SandboxStreamEvent.draft_policy_update:type_name -> openshell.v1.DraftPolicyUpdate
	204, // 50: openshell.v1.SandboxLogLine.fields:type_name -> openshell.v1.SandboxLogLine.FieldsEntry
	223, // 51: openshell.v1.CreateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	223, // 52: openshell.v1.UpdateProviderRequest.provider:type_name -> openshell.datamodel.v1.Provider
	205, // 53: openshell.v1.UpdateProviderRequest.credential_expires_at_ms:type_name -> openshell.v1.UpdateProviderRequest.CredentialExpiresAtMsEntry
	223, // 54: openshell.v1.ProviderResponse.provider:type_name -> openshell.datamodel.v1.Provider
	223, // 55: openshell.v1.ListProvidersResponse.providers:type_name -> openshell.datamodel.v1.Provider
	98,  // 56: openshell.v1.ProviderProfileImportItem.profile:type_name -> openshell.v1.ProviderProfile
	81,  // 57: openshell.v1.ProviderCredentialTokenGrant.audience_overrides:type_name -> openshell.v1.ProviderCredentialTokenGrantAudienceOverride
	86,  // 58: openshell.v1.ProviderProfileCredential.refresh:type_name -> openshell.v1.ProviderCredentialRefresh
	82,  // 59: openshell.v1.ProviderProfileCredential.token_grant:type_name -> openshell.v1.ProviderCredentialTokenGrant
	2,   // 60: openshell.v1.ProviderCredentialRefresh.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	84,  // 61: openshell.v1.ProviderCredentialRefresh.material:type_name -> openshell.v1.ProviderCredentialRefreshMaterial
	85,  // 62: openshell.v1.ProviderCredentialRefresh.additional_outputs:type_name -> openshell.v1.ProviderCredentialRefreshOutput
	2,   // 63: openshell.v1.ProviderCredentialRefreshStatus.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	220, // 64: openshell.v1.StoredProviderCredentialRefreshState.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	2,   // 65: openshell.v1.StoredProviderCredentialRefreshState.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	206, // 66: openshell.v1.StoredProviderCredentialRefreshState.material:type_name -> openshell.v1.StoredProviderCredentialRefreshState.MaterialEntry
	207, // 67: openshell.v1.StoredProviderCredentialRefreshState.additional_output_keys:type_name -> openshell.v1.StoredProviderCredentialRefreshState.AdditionalOutputKeysEntry
	87,  // 68: openshell.v1.GetProviderRefreshStatusResponse.credentials:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	2,   // 69: openshell.v1.ConfigureProviderRefreshRequest.strategy:type_name -> openshell.v1.ProviderCredentialRefreshStrategy
	...
	87,  // 71: openshell.v1.ConfigureProviderRefreshResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	87,  // 72: openshell.v1.RotateProviderCredentialResponse.status:type_name -> openshell.v1.ProviderCredentialRefreshStatus
	3,   // 73: openshell.v1.ProviderProfile.category:type_name -> openshell.v1.ProviderProfileCategory
	83,  // 74: openshell.v1.ProviderProfile.credentials:type_name -> openshell.v1.ProviderProfileCredential
	...
	88,  // 77: openshell.v1.ProviderProfile.discovery:type_name -> openshell.v1.ProviderProfileDiscovery
	...
	98,  // 80: openshell.v1.StoredProviderProfile.profile:type_name -> openshell.v1.ProviderProfile
	98,  // 81: openshell.v1.ProviderProfileResponse.profile:type_name -> openshell.v1.ProviderProfile
	98,  // 82: openshell.v1.ListProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	79,  // 83: openshell.v1.ImportProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	80,  // 84: openshell.v1.ImportProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	98,  // 85: openshell.v1.ImportProviderProfilesResponse.profiles:type_name -> openshell.v1.ProviderProfile
	79,  // 86: openshell.v1.UpdateProviderProfilesRequest.profile:type_name -> openshell.v1.ProviderProfileImportItem
	80,  // 87: openshell.v1.UpdateProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	98,  // 88: openshell.v1.UpdateProviderProfilesResponse.profile:type_name -> openshell.v1.ProviderProfile
	79,  // 89: openshell.v1.LintProviderProfilesRequest.profiles:type_name -> openshell.v1.ProviderProfileImportItem
	80,  // 90: openshell.v1.LintProviderProfilesResponse.diagnostics:type_name -> openshell.v1.ProviderProfileDiagnostic
	112, // 91: openshell.v1.StaticCredentialBinding.endpoints:type_name -> openshell.v1.StaticCredentialEndpointBinding
	...
	116, // 98: openshell.v1.UpdateConfigRequest.merge_operations:type_name -> openshell.v1.PolicyMergeOperation
	214, // 99: openshell.v1.UpdateConfigRequest.annotations:type_name -> openshell.v1.UpdateConfigRequest.AnnotationsEntry
	117, // 100: openshell.v1.PolicyMergeOperation.add_rule:type_name -> openshell.v1.AddNetworkRule
	118, // 101: openshell.v1.PolicyMergeOperation.remove_endpoint:type_name -> openshell.v1.RemoveNetworkEndpoint
	119, // 102: openshell.v1.PolicyMergeOperation.remove_rule:type_name -> openshell.v1.RemoveNetworkRule
	120, // 103: openshell.v1.PolicyMergeOperation.add_deny_rules:type_name -> openshell.v1.AddDenyRules
	121, // 104: openshell.v1.PolicyMergeOperation.add_allow_rules:type_name -> openshell.v1.AddAllowRules
	122, // 105: openshell.v1.PolicyMergeOperation.remove_binary:type_name -> openshell.v1.RemoveNetworkBinary
	...
	130, // 110: openshell.v1.GetSandboxPolicyStatusResponse.revision:type_name -> openshell.v1.SandboxPolicyRevision
	130, // 111: openshell.v1.ListSandboxPoliciesResponse.revisions:type_name -> openshell.v1.SandboxPolicyRevision
	4,   // 112: openshell.v1.ReportPolicyStatusRequest.status:type_name -> openshell.v1.PolicyStatus
	4,   // 113: openshell.v1.SandboxPolicyRevision.status:type_name -> openshell.v1.PolicyStatus
	...
	68,  // 116: openshell.v1.PushSandboxLogsRequest.logs:type_name -> openshell.v1.SandboxLogLine
	68,  // 117: openshell.v1.GetSandboxLogsResponse.logs:type_name -> openshell.v1.SandboxLogLine
	137, // 118: openshell.v1.SupervisorMessage.hello:type_name -> openshell.v1.SupervisorHello
	140, // 119: openshell.v1.SupervisorMessage.heartbeat:type_name -> openshell.v1.SupervisorHeartbeat
	149, // 120: openshell.v1.SupervisorMessage.relay_open_result:type_name -> openshell.v1.RelayOpenResult
	150, // 121: openshell.v1.SupervisorMessage.relay_close:type_name -> openshell.v1.RelayClose
	142, // 122: openshell.v1.SupervisorMessage.main_process_exit:type_name -> openshell.v1.MainProcessExit
	138, // 123: openshell.v1.GatewayMessage.session_accepted:type_name -> openshell.v1.SessionAccepted
	139, // 124: openshell.v1.GatewayMessage.session_rejected:type_name -> openshell.v1.SessionRejected
	141, // 125: openshell.v1.GatewayMessage.heartbeat:type_name -> openshell.v1.GatewayHeartbeat
	144, // 126: openshell.v1.GatewayMessage.relay_open:type_name -> openshell.v1.RelayOpen
	150, // 127: openshell.v1.GatewayMessage.relay_close:type_name -> openshell.v1.RelayClose
	143, // 128: openshell.v1.GatewayMessage.main_process_exit_ack:type_name -> openshell.v1.MainProcessExitAck
	145, // 129: openshell.v1.RelayOpen.ssh:type_name -> openshell.v1.SshRelayTarget
	146, // 130: openshell.v1.RelayOpen.tcp:type_name -> openshell.v1.TcpRelayTarget
	147, // 131: openshell.v1.RelayFrame.init:type_name -> openshell.v1.RelayInit
	151, // 132: openshell.v1.DenialSummary.l7_request_samples:type_name -> openshell.v1.L7RequestSample
	153, // 133: openshell.v1.NetworkActivitySummary.denials_by_group:type_name -> openshell.v1.DenialGroupCount
	227, // 134: openshell.v1.PolicyChunk.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	152, // 135: openshell.v1.SubmitPolicyAnalysisRequest.summaries:type_name -> openshell.v1.DenialSummary
	155, // 136: openshell.v1.SubmitPolicyAnalysisRequest.proposed_chunks:type_name -> openshell.v1.PolicyChunk
	154, // 137: openshell.v1.SubmitPolicyAnalysisRequest.network_activity_summaries:type_name -> openshell.v1.NetworkActivitySummary
	155, // 138: openshell.v1.GetDraftPolicyResponse.chunks:type_name -> openshell.v1.PolicyChunk
	227, // 139: openshell.v1.EditDraftChunkRequest.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	174, // 140: openshell.v1.GetDraftHistoryResponse.entries:type_name -> openshell.v1.DraftHistoryEntry
	221, // 141: openshell.v1.PolicyRevisionPayload.policy:type_name -> openshell.sandbox.v1.SandboxPolicy
	217, // 142: openshell.v1.PolicyRevisionPayload.provenance:type_name -> openshell.v1.PolicyRevisionPayload.ProvenanceEntry
	227, // 143: openshell.v1.DraftChunkPayload.proposed_rule:type_name -> openshell.sandbox.v1.NetworkPolicyRule
	218, // 144: openshell.v1.StoredPolicyRevision.provenance:type_name -> openshell.v1.StoredPolicyRevision.ProvenanceEntry
	219, // 145: openshell.v1.CreateWorkspaceRequest.labels:type_name -> openshell.v1.CreateWorkspaceRequest.LabelsEntry
	230, // 146: openshell.v1.CreateWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	230, // 147: openshell.v1.GetWorkspaceResponse.workspace:type_name -> openshell.datamodel.v1.Workspace
	230, // 148: openshell.v1.ListWorkspacesResponse.workspaces:type_name -> openshell.datamodel.v1.Workspace
	220, // 149: openshell.v1.WorkspaceMember.metadata:type_name -> openshell.datamodel.v1.ObjectMeta
	...
	188, // 152: openshell.v1.AddWorkspaceMemberResponse.member:type_name -> openshell.v1.WorkspaceMember
	188, // 153: openshell.v1.ListWorkspaceMembersResponse.members:type_name -> openshell.v1.WorkspaceMember
	...
	231, // 192: openshell.v1.OpenShell.GetSandboxConfig:input_type -> openshell.sandbox.v1.GetSandboxConfigRequest
	232, // 193: openshell.v1.OpenShell.GetGatewayConfig:input_type -> openshell.sandbox.v1.GetGatewayConfigRequest
	...
	148, // 202: openshell.v1.OpenShell.RelayStream:input_type -> openshell.v1.RelayFrame
	66,  // 203: openshell.v1.OpenShell.WatchSandbox:input_type -> openshell.v1.WatchSandboxRequest
	157, // 204: openshell.v1.OpenShell.SubmitPolicyAnalysis:input_type -> openshell.v1.SubmitPolicyAnalysisRequest
	159, // 205: openshell.v1.OpenShell.GetDraftPolicy:input_type -> openshell.v1.GetDraftPolicyRequest
	161, // 206: openshell.v1.OpenShell.ApproveDraftChunk:input_type -> openshell.v1.ApproveDraftChunkRequest
	163, // 207: openshell.v1.OpenShell.RejectDraftChunk:input_type -> openshell.v1.RejectDraftChunkRequest
	165, // 208: openshell.v1.OpenShell.ApproveAllDraftChunks:input_type -> openshell.v1.ApproveAllDraftChunksRequest
	167, // 209: openshell.v1.OpenShell.EditDraftChunk:input_type -> openshell.v1.EditDraftChunkRequest
	169, // 210: openshell.v1.OpenShell.UndoDraftChunk:input_type -> openshell.v1.UndoDraftChunkRequest
	171, // 211: openshell.v1.OpenShell.ClearDraftChunks:input_type -> openshell.v1.ClearDraftChunksRequest
	173, // 212: openshell.v1.OpenShell.GetDraftHistory:input_type -> openshell.v1.GetDraftHistoryRequest
	...
	180, // 215: openshell.v1.OpenShell.CreateWorkspace:input_type -> openshell.v1.CreateWorkspaceRequest
	182, // 216: openshell.v1.OpenShell.GetWorkspace:input_type -> openshell.v1.GetWorkspaceRequest
	184, // 217: openshell.v1.OpenShell.ListWorkspaces:input_type -> openshell.v1.ListWorkspacesRequest
	186, // 218: openshell.v1.OpenShell.DeleteWorkspace:input_type -> openshell.v1.DeleteWorkspaceRequest
	189, // 219: openshell.v1.OpenShell.AddWorkspaceMember:input_type -> openshell.v1.AddWorkspaceMemberRequest
	191, // 220: openshell.v1.OpenShell.RemoveWorkspaceMember:input_type -> openshell.v1.RemoveWorkspaceMemberRequest
	193, // 221: openshell.v1.OpenShell.ListWorkspaceMembers:input_type -> openshell.v1.ListWorkspaceMembersRequest
	...
	148, // 268: openshell.v1.OpenShell.RelayStream:output_type -> openshell.v1.RelayFrame
	67,  // 269: openshell.v1.OpenShell.WatchSandbox:output_type -> openshell.v1.SandboxStreamEvent
	158, // 270: openshell.v1.OpenShell.SubmitPolicyAnalysis:output_type -> openshell.v1.SubmitPolicyAnalysisResponse
	160, // 271: openshell.v1.OpenShell.GetDraftPolicy:output_type -> openshell.v1.GetDraftPolicyResponse
	162, // 272: openshell.v1.OpenShell.ApproveDraftChunk:output_type -> openshell.v1.ApproveDraftChunkResponse
	164, // 273: openshell.v1.OpenShell.RejectDraftChunk:output_type -> openshell.v1.RejectDraftChunkResponse
	166, // 274: openshell.v1.OpenShell.ApproveAllDraftChunks:output_type -> openshell.v1.ApproveAllDraftChunksResponse
	168, // 275: openshell.v1.OpenShell.EditDraftChunk:output_type -> openshell.v1.EditDraftChunkResponse
	170, // 276: openshell.v1.OpenShell.UndoDraftChunk:output_type -> openshell.v1.UndoDraftChunkResponse
	172, // 277: openshell.v1.OpenShell.ClearDraftChunks:output_type -> openshell.v1.ClearDraftChunksResponse
	175, // 278: openshell.v1.OpenShell.GetDraftHistory:output_type -> openshell.v1.GetDraftHistoryResponse
	...
	181, // 281: openshell.v1.OpenShell.CreateWorkspace:output_type -> openshell.v1.CreateWorkspaceResponse
	183, // 282: openshell.v1.OpenShell.GetWorkspace:output_type -> openshell.v1.GetWorkspaceResponse
	185, // 283: openshell.v1.OpenShell.ListWorkspaces:output_type -> openshell.v1.ListWorkspacesResponse
	187, // 284: openshell.v1.OpenShell.DeleteWorkspace:output_type -> openshell.v1.DeleteWorkspaceResponse
	190, // 285: openshell.v1.OpenShell.AddWorkspaceMember:output_type -> openshell.v1.AddWorkspaceMemberResponse
	192, // 286: openshell.v1.OpenShell.RemoveWorkspaceMember:output_type -> openshell.v1.RemoveWorkspaceMemberResponse
	194, // 287: openshell.v1.OpenShell.ListWorkspaceMembers:output_type -> openshell.v1.ListWorkspaceMembersResponse
