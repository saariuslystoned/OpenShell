...
filesystems, OpenShell control paths, OCI runtime mounts, and workspace roots
that would cover essential execution or library paths. Before workload launch,
